...
//	 }
	 ...
	 @CrossOrigin
	    ...
	    public ResponseEntity<?> countByDepartmentIdAndMonth(@RequestParam String departmentid,@RequestParam String month) {
		 HttpHeaders headers = new HttpHeaders();
	        ...
	        try {
				System.out.println(attendanceservice.countByDepartmentIdAndMonth(departmentid,month));
	 ...
	 @CrossOrigin
	    @ResponseBody
	    public ResponseEntity<?> countByEmployeeIdAndDepartmentIdAndMonth(@RequestParam String employeeid,@RequestParam String departmentid,@RequestParam String month) {
		 HttpHeaders headers = new HttpHeaders();
	        
	        try {
				System.out.println(attendanceservice.countByEmployeeIdAndDepartmentIdAndMonth(employeeid,departmentid,month));
	 ...
	 @CrossOrigin
	    ...
	    public ResponseEntity<?> countByEmployeeIdAndDepartmentId(@RequestParam String employeeid,@RequestParam String departmentid) {
		 HttpHeaders headers = new HttpHeaders();
	        ...
	        try {
				System.out.println(attendanceservice.countByEmployeeIdAndDepartmentId(employeeid,departmentid));
	 ...
	 @CrossOrigin
	    ...
	    public ResponseEntity<?> countByEmployeeIdAndDepartmentIdAndAvailable(@RequestParam String employeeid,@RequestParam String departmentid,@RequestParam Boolean available) {
		 HttpHeaders headers = new HttpHeaders();
	        try {
				System.out.println(attendanceservice.countByEmployeeIdAndDepartmentIdAndAvailable(employeeid,departmentid,available));
	 ...
	 @CrossOrigin
	    ...
	    public ResponseEntity<?> findBydeptid(@RequestParam String departmentid) {
		 HttpHeaders headers = new HttpHeaders();
	        ...
	        try {   	
	        	//System.out.println("en da ipdi "+employeeid+employeeservice.findByempid(employeeid));
				System.out.println(Arrays.toString(attendanceservice.findBydeptid(departmentid)));
	 ...
	 @CrossOrigin
	    ...
	    public ResponseEntity<?> findBydate(@RequestParam String date) {
		 HttpHeaders headers = new HttpHeaders();
	        ...
	        try {   	
	        	//System.out.println("en da ipdi "+employeeid+employeeservice.findByempid(employeeid));
				System.out.println(attendanceservice.findBydate(date));
	 ...
	 @CrossOrigin
	    ...
	    public ResponseEntity<?> sortdeptview(@RequestParam String departmentId,@RequestParam String month,@RequestParam String shift) {
		 HttpHeaders headers = new HttpHeaders();
	        ...
	        try {
				System.out.println(attendanceservice.sortdeptview(departmentId,month,shift));
	        	//System.out.println("en da ipdi "+employeeid+employeeservice.findByempid(employeeid));
	 ...
	 @CrossOrigin
	    ...
	    public AttendanceDetail findByName(@RequestParam String employeeid,@RequestParam String departmentid) {
		 System.out.println(attendanceservice.findByName(employeeid, departmentid));
